...
class PostalizzazioneEngineProcessor(BaseProcessModel):
    ...
    per la formazione e postalizzazione (reingegnerizzazione del programma COBOL).
    ...
    def _execute_business_logic(self):
        ...
        # ------------------------------------------------------------------
        print("   >> [UPD-STATO-INI-FORM] Avanzamento stato a '9' e aggiornamento marcatura temporale...")
